...
const Aside = ({ isOpen, onToggle }: AsideProps) => {
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600 mb-3">
                  Confira nossa documentação e tutoriais
                </p>
                <button className="text-xs font-medium text-orange-600 hover:text-orange-700 transition-colors duration-200">
                  Ver documentação →
                </button>
              </div>
            </div>
