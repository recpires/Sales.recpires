...
import { Form, Input, Button, Steps, Card, Typography, message, Row, Col, Divider, Select, Radio, Tag, Space, Spin } from 'antd';
import { UserOutlined, CheckCircleOutlined, ArrowLeftOutlined, CreditCardOutlined, BarcodeOutlined, WalletOutlined, EnvironmentOutlined } from '@ant-design/icons';
...
const checkoutSchema = z.object({
  ...
  customer_phone: z.string().min(10, 'Telefone deve ter no mínimo 10 caracteres'),
...
const CheckoutPage: React.FC = () => {
  ...
  const { control, handleSubmit, formState: { errors }, setValue, watch } = useForm<CheckoutFormData>({
            ...
            <Form layout="vertical" onFinish={handleSubmit(onSubmit)}>
              ...
              >
                <Controller
                  name="customer_name"
                  control={control}
                  render={({ field }) => <Input {...field} placeholder="Seu nome completo" size="large" />}
                />
              </Form.Item>
                ...
                <Col span={12}>
                  ...
                  >
                    <Controller
                      name="customer_email"
                      control={control}
                      render={({ field }) => <Input {...field} placeholder="seu@email.com" type="email" size="large" />}
                    />
                  </Form.Item>
                </Col>
                <Col span={12}>
                  ...
                  >
                    <Controller
                      name="customer_phone"
                      control={control}
                      render={({ field }) => <Input {...field} placeholder="(11) 98765-4321" size="large" />}
                    />
                  </Form.Item>
                </Col>
              </Row>
            ...
            <Form layout="vertical" onFinish={handleSubmit(onSubmit)}>
              <Row gutter={16}>
                ...
                <Col span={12}>
                  {shippingType && (
                    <div className="mt-8">
                      <Tag color={shippingCost === 0 ? 'green' : 'blue'} className="text-sm py-1 px-3">
                        {shippingType}: {shippingCost === 0 ? 'GRÁTIS' : `R$ ${shippingCost.toFixed(2)}`}
                      </Tag>
                ...
                <Col span={18}>
                  ...
                  >
                    <Controller
                      name="street"
                      control={control}
                      render={({ field }) => <Input {...field} placeholder="Nome da rua" size="large" />}
                    />
                  </Form.Item>
                </Col>
                <Col span={6}>
                  ...
                  >
                    <Controller
                      name="number"
                      control={control}
                      render={({ field }) => <Input {...field} placeholder="123" size="large" />}
                    />
                  </Form.Item>
                </Col>
              </Row>
              ...
              >
                <Controller
                  name="complement"
                  control={control}
                  render={({ field }) => <Input {...field} placeholder="Apto, bloco, etc." size="large" />}
                />
              </Form.Item>
                ...
                <Col span={12}>
                  ...
                  >
                    <Controller
                      name="neighborhood"
                      control={control}
                      render={({ field }) => <Input {...field} placeholder="Nome do bairro" size="large" />}
                    />
                  </Form.Item>
                </Col>
                <Col span={10}>
                  ...
                  >
                    <Controller
                      name="city"
                      control={control}
                      render={({ field }) => <Input {...field} placeholder="Nome da cidade" size="large" />}
                    />
                  </Form.Item>
                </Col>
                <Col span={2}>
                  ...
                  >
                    <Controller
                      name="state"
                      control={control}
                      render={({ field }) => <Input {...field} placeholder="SP" size="large" maxLength={2} />}
                    />
                  </Form.Item>
                </Col>
              </Row>
                  ...
                  render={({ field }) => (
                    <Radio.Group {...field} size="large" className="w-full">
                      <Space direction="vertical" className="w-full">
                        <Radio.Button value="pix" className="w-full h-16 text-left">
                          <Space>
                            <WalletOutlined style={{ fontSize: 24, color: '#32bcad' }} />
                            <div>
                        ...
                        <Radio.Button value="credit_card" className="w-full h-16 text-left">
                          <Space>
                        ...
                        <Radio.Button value="debit_card" className="w-full h-16 text-left">
                          <Space>
                        ...
                        <Radio.Button value="boleto" className="w-full h-16 text-left">
                          <Space>
                            <BarcodeOutlined style={{ fontSize: 24, color: '#fa8c16' }} />
                            <div>
                  ...
                  <div key={`${item.productId}-${item.variantId}`} className="flex gap-3 pb-3 border-b border-gray-100">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex justify-between mt-1">
                        ...
                        <Text strong className="text-sm">R$ {(unitPrice * item.quantity).toFixed(2)}</Text>
                      </div>
                    </div>
                  </div>
                );
            ...
            <Row justify="space-between" className="mb-4">
              ...
              <Col>
                {shippingCost === 0 ? (
                  ...
                  <Text type="secondary" className="text-xs">Informe o CEP</Text>
                )}
              </Col>
            </Row>
            ...
            <div className="bg-blue-50 p-3 rounded-lg">
              <Text className="text-xs">
                <div className="flex items-start gap-2">
                  <span>🔒</span>
                  <div>
                    <Text strong className="text-xs">Pagamento Seguro</Text>
                    <br />
                    <Text type="secondary" className="text-xs">
  ...
  const renderConfirmationStep = () => (
    <animated.div style={fadeIn}>
      <Card style={{ textAlign: 'center', padding: '60px 40px', maxWidth: 600, margin: '0 auto' }}>
        <CheckCircleOutlined style={{ fontSize: 96, color: '#52c41a', marginBottom: 32 }} />
        <Title level={2}>🎉 Pedido Realizado com Sucesso!</Title>
        <Text type="secondary" style={{ fontSize: 18, display: 'block', marginTop: 16 }}>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <Title level={2} className="mb-2">Finalizar Compra</Title>
